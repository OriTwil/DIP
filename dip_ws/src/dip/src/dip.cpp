...
public:
    ...
    void info(Mat frIn){
        if(mapOK){
            ...
            putText(mapMat, hRes, Point( mapMat.cols - 200, 20 ), cv::FONT_HERSHEY_COMPLEX_SMALL, 0.85, Scalar(0, 0, 255));
            putText(mapMat, runRes, Point( mapMat.cols - 200, 40 ), cv::FONT_HERSHEY_COMPLEX_SMALL, 0.85, Scalar(0, 0, 255));
            putText(mapMat, linear, Point( mapMat.cols - 200, 60 ), cv::FONT_HERSHEY_COMPLEX_SMALL, 0.85, Scalar(0, 0, 255));
            putText(mapMat, angular, Point( mapMat.cols - 200, 80 ), cv::FONT_HERSHEY_COMPLEX_SMALL, 0.85, Scalar(0, 0, 255));
            putText(mapMat, distc, Point( mapMat.cols - 200, 100 ), cv::FONT_HERSHEY_COMPLEX_SMALL, 0.85, Scalar(0, 0, 255));
