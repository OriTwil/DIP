 ...
 */
Mat GaussianTemplate3(double sigma)
{
...
Mat ImgConvolve3(Mat src, Mat kernel)
{
...
// 空域高斯滤波
Mat Gaussian3(Mat input, double sigma)
{
    Mat tplt = GaussianTemplate3(sigma);
    return ImgConvolve3(input, tplt);
}
